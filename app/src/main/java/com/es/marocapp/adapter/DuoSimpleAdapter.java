...
public class DuoSimpleAdapter extends BaseAdapter {
    private ArrayList<String> mOptions = new ArrayList<>();
    private ArrayList<Integer> mOptionsIcons = new ArrayList<>();
    private ArrayList<DuoOptionView> mOptionViews = new ArrayList<>();

    public DuoSimpleAdapter(ArrayList<String> options, ArrayList<Integer> mNavigationViewIcons) {
        mOptions = options;
        mOptionsIcons = mNavigationViewIcons;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Integer optionIcon = mOptionsIcons.get(position);
        ...
        optionView.bind(option, optionIcon);

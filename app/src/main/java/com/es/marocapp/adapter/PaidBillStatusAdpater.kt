...
class PaidBillStatusAdpater (private val billStatus : ArrayList<PostPaidBillPaymentResponse>,val listOfSelectedBillAmount : ArrayList<String>,
                             val listOfSelectedBillFee : ArrayList<String> ,
                             val receiverNumber : String,
                             val recieverName : String
                ) : RecyclerView.Adapter<PaidBillStatusAdpater.BillPaymentItemViewHolder>() {
